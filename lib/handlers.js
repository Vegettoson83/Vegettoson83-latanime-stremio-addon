    ...
    builder.defineStreamHandler(async ({type, id}) => {
        ...
        try {
            ...
            playerAttributes.forEach(attr => {
                mainContainer.find(`*:not(img)[${attr}]`).each((i, el) => {
            ...
            mainContainer.find('iframe').each((i, el) => {
            ...
            mainContainer.find('video source, video').each((i, el) => {
            ...
            mainContainer.find('button[data-player], .player-option, .server-item').each((i, el) => {
