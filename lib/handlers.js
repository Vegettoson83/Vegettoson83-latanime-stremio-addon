            ...
            for (const provider of providers) {
                ...
                try {
                    ...
                    if (finalUrl && !finalUrl.includes('listeamed.net')) {
                        console.log(`Found valid final embed URL for ${provider.title}: ${finalUrl.substring(0, 60)}...`);
                    ...
                    console.error(`Failed processing provider ${provider.title} (${provider.url}): ${e.message}`);
                } finally {
